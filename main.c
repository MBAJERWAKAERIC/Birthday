...
printf("\t                                                                          %c",186);
sleep(1);
printf("\t                                                                    %c Ruben %c C %c J ",178,177,176);
sleep(3);
printf("\t                                                                        %c ",188);
sleep(1);
printf("\t                                                 BUCOSA with you");
sleep(2);
printf("\t                                                                       %c",25);
sleep(1);
printf("\t                                                                       %c",186);
...
sleep(2);
printf("\t                                                             Bugema university");
sleep(2);
printf("\t                                                          %c%c%c%c%c%c%c%c%c",201,205,205,205,205,205,205,205,205);
printf("\t                %c%c%c BUSA %c%c%c%c%c%c%c%c%c MRE-Soft %c%c%c%c%c%c%c%c Our programmer%c%c%c%c%c%c we all loves you",206,205,205,254,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205,205);
sleep(2);

printf("\t\t\t\t All blessings upon you ");
sleep(1);
